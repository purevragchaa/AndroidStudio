...
public class MainActivity extends AppCompatActivity implements PopupMenu.OnMenuItemClickListener {
    ...
    private void forecastCal(TextView forecast,TextView forecastTemp,ImageView forecastIcons,int index,JSONObject json) throws JSONException {
        ...
        for (int i=index; i<list.length(); i++) {
            ...
            String dt=object.getString("dt_txt"); // dt_text.format=2022-10-16 12:00:00
            String[] a=dt.split(" ");
            if ((i==list.length()-1) && !a[1].equals("12:00:00")){
                ...
                switch (forecastDateSplit[0]){
                    case "Sat":
                        forecastDateSplit[0]="Sat";
                        break;
                    case "Sun":
                        forecastDateSplit[0]="Sun";
                        break;
                    case "Mon":
                        forecastDateSplit[0]="Mon";
                        break;
                    case "Tue":
                        forecastDateSplit[0]="Tue";
                        break;
                    case "Wed":
                        forecastDateSplit[0]="Wed";
                        break;
                    case "Thu":
                        forecastDateSplit[0]="Thu";
                        break;
                    case "Fri":
                        forecastDateSplit[0]="Fri";
                        break;
                }
                switch (forecastDateSplit[1]){
                    case "Jan":
                        forecastDateSplit[1]="Jan";
                        break;
                    case "Feb":
                        forecastDateSplit[1]="Feb";
                        break;
                    case "Mar":
                        forecastDateSplit[1]="Mar";
                        break;
                    case "Apr":
                        forecastDateSplit[1]="Apr";
                        break;
                    case "May":
                        forecastDateSplit[1]="May";
                        break;
                    case "June":
                        forecastDateSplit[1]="June";
                        break;
                    case "Jul":
                        forecastDateSplit[1]="Jul";
                        break;
                    case "Aug":
                        forecastDateSplit[1]="Aug";
                        break;
                    case "Sept":
                        forecastDateSplit[1]="Sep";
                        break;
                    case "Oct":
                        forecastDateSplit[1]="Oct";
                        break;
                    case "Nov":
                        forecastDateSplit[1]="Nov";
                        break;
                    case "Dec":
                        forecastDateSplit[1]="Dec";
                        break;
                }
                String date=forecastDateSplit[0]+", "+forecastDateSplit[1] +" "+forecastDateSplit[2];
                setDataText(forecast, date);
